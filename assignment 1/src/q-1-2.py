    ...
    if key==-1:
        ...
        for value in unique_vals:
            ...
            if n!=-1:            
                ...
                tree[(name_list[column],key)][value]=decision_tree(column_list,new_data)
        ...
        if n!=-1:            
            ...
            tree[(name_list[column],key)]["greater"]=decision_tree(column_list,data_greater)
        ...
        if n!=-1:
            ...
            tree[(name_list[column],key)]["smaller"]=decision_tree(column_list,data_smaller)
...
# print(falsee,truee)
# print(sum(validate_data[:,6]),len(validate_data)-sum(validate_data[:,6]))
# print(truee/(truee+falsee))
